...
export function zolePublicSnapshot(state, forPlayerIdx) {
  ...
  return {
    ...
    trumpNote:
      "Trumpji (lāči): visas D un J visos mastos, kā arī ♦ 7–A (izņemot D/J — tie jau kā trumpji).\n\n" +
      "Parastās: ♣ ♥ ♠ — A, 10, K, 9 (tās nav trumpji).\n\n" +
      "Stiķī stiprāks ir jebkurš trumpis par jebkuru parasto. Sekšana: pirmā kārta nosaka VADĪBAS MASTU (♣/♦/♥/♠). " +
      "D un J ir attiecīgā masta kārtas — ja ved ♥, ♥D un ♥J jāliek kā ♥, ja tās rokā ir.\n\n" +
      "Ja vadības masta kārtis rokā IR — jāspēlē šis masts. Ja NAV — vari jebkuru: citu parasto masta vai jebkuru trumpi.",
    turn: state.turn,
