 ...
 * ja tāda ir. Dāmu/kalpu drīkst lietot uz parasto vadību tikai tad, ja rokā nav nevienas
 * parastās kārtis šajā mastā. Ja vada trumpis — jāspēlē jebkurš trumpis, ja ir; ja nav — parastās (atmesties).
 */
...
export function zolePublicSnapshot(state, forPlayerIdx) {
  ...
  return {
    ...
    trumpNote:
      ...
      "D/J tikai ja parastās nav. Ja masta nav — atmesties. " +
