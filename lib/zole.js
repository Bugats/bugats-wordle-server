...
export function zolePublicSnapshot(state, forPlayerIdx) {
  ...
  return {
    ...
    trumpNote:
      "Dāma un kalps IR trumpa kārtis jebkurā mastā (tās nav „parastās”). Papildus trumpji: ♦ 7–A. " +
      "Parastās ir tikai ♣ ♥ ♠ — A, 10, K, 9.\n\n" +
      "Kad vada PARASTĀ — obligāti tas pats masts; ♥D un ♥J šajā gadījumā jāspēlē kā ♥ (sekšana), bet tās joprojām ir trumpa kārtis. " +
      "Ja masta nav — atmesties.\n\n" +
      "Kad vada TRUMPIS — obligāti jebkurš trumpis, ja ir; ja nav neviena D/J/♦ trumpja — tikai parastā (atmesties).",
    turn: state.turn,
